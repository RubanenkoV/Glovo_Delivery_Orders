    ...
    public static void main(String[] args) {
        ...
        for (Account user : users) {
            ...
            if (accessType == Account.AccessType.Guest) {
                ...
                if (user.authenticate(userLogin, userPassword) && userPassword.equals(passwordFromUserStorage)) {
                ...
                if (user.authenticate(userLogin, userPassword) && userPassword.equals(passwordFromAdminsStorage) && userPassword.length() >= 8) {
