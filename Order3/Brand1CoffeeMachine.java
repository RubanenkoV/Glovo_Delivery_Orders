class Brand1CoffeeMachine implements CoffeeMachine {
    private static final double COST_ESPRESSO = 1.5;
    private static final double COST_AMERICANO = 2.0;
    private static final double COST_CAPPUCCINO = 2.5;
    private static final double COST_LATTE = 3.0;
    private static final double SERVICE_COST = 10.0;

    @Override
    public void brewCoffee(String coffeeType) {
        // Приготування кави за допомогою кавової машини Brand 1
        System.out.println("Brewing coffee using Brand 1 coffee machine.");
